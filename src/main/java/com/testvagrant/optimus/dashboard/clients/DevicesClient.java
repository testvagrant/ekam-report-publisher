package com.testvagrant.optimus.dashboard.clients;
...
public class DevicesClient extends RetrofitBaseClient {
    ...
    public boolean isDevicePresent(String buildId, String udid) {
        Device deviceResponse = httpClient.execute(devicesService.findDeviceByBuildIdAndUdid(buildId, udid));
    ...
    private interface DevicesService {
        ...
        Call<Device> findDeviceByBuildIdAndUdid(@Query("buildId") String buildId, @Query("udid") String udid);
    }
}
